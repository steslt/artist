...
function setEng() {
    ...
    document.getElementById('img-1').setAttribute('data-description', 'Acrylic 120×120')
    document.getElementById('img-title-1').innerText = 'The Fabric of Time»'
    document.getElementById('img-subtitle-1').innerText = 'Acrylic 120×120'

    document.getElementById('img-2').setAttribute('data-title', '«And You, Do You Like Pears?»')
    document.getElementById('img-2').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-2').innerText = '«And You, Do You Like Pears?»'
    document.getElementById('img-subtitle-2').innerText = 'Acrylic 130×130'

    document.getElementById('img-3').setAttribute('data-title', '«My Grape Dreams»')
    document.getElementById('img-3').setAttribute('data-description', 'Acrylic 120×120')
    document.getElementById('img-title-3').innerText = '«My Grape Dreams»'
    document.getElementById('img-subtitle-3').innerText = 'Acrylic 120×120'

    document.getElementById('img-4').setAttribute('data-title', '«The Air»')
    document.getElementById('img-4').setAttribute('data-description', 'Acrylic 120×120')
    document.getElementById('img-title-4').innerText = '«The Air»'
    document.getElementById('img-subtitle-4').innerText = 'Acrylic 120×120'

    document.getElementById('img-5').setAttribute('data-title', '«Dark Horses»')
    document.getElementById('img-5').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-5').innerText = '«Dark Horses»'
    document.getElementById('img-subtitle-5').innerText = 'Acrylic 130×130'

    document.getElementById('img-6').setAttribute('data-title', '«The Secret Between Us»')
    document.getElementById('img-6').setAttribute('data-description', 'Acrylic 120×120')
    document.getElementById('img-title-6').innerText = '«The Secret Between Us»'
    document.getElementById('img-subtitle-6').innerText = 'Acrylic 120×120'

    document.getElementById('img-7').setAttribute('data-title', '«No One Knows What`s  in My Pockets…»')
    document.getElementById('img-7').setAttribute('data-description', 'Acrylic 120×120')
    document.getElementById('img-title-7').innerText = '«No One Knows What`s  in My Pockets…»'
    document.getElementById('img-subtitle-7').innerText = 'Acrylic 120×120'

    document.getElementById('img-8').setAttribute('data-title', '«Hair in the Wind»')
    document.getElementById('img-8').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-8').innerText = '«Hair in the Wind»'
    document.getElementById('img-subtitle-8').innerText = 'Acrylic 130×130'

    document.getElementById('img-9').setAttribute('data-title', '«Mara and Her Dogs Catch the Wind»')
    document.getElementById('img-9').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-9').innerText = '«Mara and Her Dogs Catch the Wind»'
    document.getElementById('img-subtitle-9').innerText = 'Acrylic 130×130'

    document.getElementById('img-10').setAttribute('data-title', '«A Warm Afternoon in the Rhоnе Valley»')
    document.getElementById('img-10').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-10').innerText = '«A Warm Afternoon in the Rhоnе Valley»'
    document.getElementById('img-subtitle-10').innerText = 'Acrylic 130×130'

    document.getElementById('img-11').setAttribute('data-title', '«My Name is Water»')
    document.getElementById('img-11').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-11').innerText = '«My Name is Water»'
    document.getElementById('img-subtitle-11').innerText = 'Acrylic 130×130'

    document.getElementById('img-12').setAttribute('data-title', '«What the Peacocks Are Silent About»')
    document.getElementById('img-12').setAttribute('data-description', 'Acrylic 130×1300')
    document.getElementById('img-title-12').innerText = '«What the Peacocks Are Silent About»'
    document.getElementById('img-subtitle-12').innerText = 'Acrylic 130×130'

    document.getElementById('img-13').setAttribute('data-title', '«Layers of Memory»')
    document.getElementById('img-13').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-13').innerText = '«Layers of Memory»'
    document.getElementById('img-subtitle-13').innerText = 'Acrylic 130×130'

    document.getElementById('img-14').setAttribute('data-title', '«Field of Wild Mint»')
    document.getElementById('img-14').setAttribute('data-description', 'Acrylic 120×120')
    document.getElementById('img-title-14').innerText = '«Field of Wild Mint»'
    document.getElementById('img-subtitle-14').innerText = 'Acrylic 120×120'

    document.getElementById('img-15').setAttribute('data-title', '«Where the Magenta Horses Fall»')
    document.getElementById('img-15').setAttribute('data-description', 'Acrylic 130×130')
    document.getElementById('img-title-15').innerText = '«Where the Magenta Horses Fall»'
    document.getElementById('img-subtitle-15').innerText = 'Acrylic 130×130'
...
function setRu() {
    ...
    document.getElementById('img-1').setAttribute('data-description', 'Акрил 120×120')
    document.getElementById('img-title-1').innerText = '«Ткань времени»'
    document.getElementById('img-subtitle-1').innerText = 'Акрил 120×120'

    document.getElementById('img-2').setAttribute('data-title', '«А вы, любите груши?»')
    document.getElementById('img-2').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-2').innerText = '«А вы, любите груши?»'
    document.getElementById('img-subtitle-2').innerText = 'Акрил 130×130'

    document.getElementById('img-3').setAttribute('data-title', '«Мои виноградные сны»')
    document.getElementById('img-3').setAttribute('data-description', 'Акрил 120×120')
    document.getElementById('img-title-3').innerText = '«Мои виноградные сны»'
    document.getElementById('img-subtitle-3').innerText = 'Акрил 120×120'

    document.getElementById('img-4').setAttribute('data-title', '«Воздух»')
    document.getElementById('img-4').setAttribute('data-description', 'Акрил 120×120')
    document.getElementById('img-title-4').innerText = '«Воздух»'
    document.getElementById('img-subtitle-4').innerText = 'Акрил 120×120'

    document.getElementById('img-5').setAttribute('data-title', '«Темные лошади»')
    document.getElementById('img-5').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-5').innerText = '«Темные лошади»'
    document.getElementById('img-subtitle-5').innerText = 'Акрил 130×130'

    document.getElementById('img-6').setAttribute('data-title', '«Тайна между нами»')
    document.getElementById('img-6').setAttribute('data-description', 'Акрил 120×120')
    document.getElementById('img-title-6').innerText = '«Тайна между нами»'
    document.getElementById('img-subtitle-6').innerText = 'Акрил 120×120'

    document.getElementById('img-7').setAttribute('data-title', '«Никто не знает, что лежит у меня в карманах…»')
    document.getElementById('img-7').setAttribute('data-description', 'Акрил 120×120')
    document.getElementById('img-title-7').innerText = '«Никто не знает, что лежит у меня в карманах…»'
    document.getElementById('img-subtitle-7').innerText = 'Акрил 120×120'

    document.getElementById('img-8').setAttribute('data-title', '«Волосы на ветру»')
    document.getElementById('img-8').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-8').innerText = '«Волосы на ветру»'
    document.getElementById('img-subtitle-8').innerText = 'Акрил 130×130'

    document.getElementById('img-9').setAttribute('data-title', '«Мара и ее собаки ловят ветер»')
    document.getElementById('img-9').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-9').innerText = '«Мара и ее собаки ловят ветер»'
    document.getElementById('img-subtitle-9').innerText = 'Акрил 130×130'

    document.getElementById('img-10').setAttribute('data-title', '«Теплый полдень в долине Роны»')
    document.getElementById('img-10').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-10').innerText = '«Теплый полдень в долине Роны»'
    document.getElementById('img-subtitle-10').innerText = 'Акрил 130×130'

    document.getElementById('img-11').setAttribute('data-title', '«Мое имя — Вода»')
    document.getElementById('img-11').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-11').innerText = '«Мое имя — Вода»'
    document.getElementById('img-subtitle-11').innerText = 'Акрил 130×130'

    document.getElementById('img-12').setAttribute('data-title', '«О чем молчат павлины»')
    document.getElementById('img-12').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-12').innerText = '«О чем молчат павлины»'
    document.getElementById('img-subtitle-12').innerText = 'Акрил 130×130'

    document.getElementById('img-13').setAttribute('data-title', '«Слои памяти»')
    document.getElementById('img-13').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-13').innerText = '«Слои памяти»'
    document.getElementById('img-subtitle-13').innerText = 'Акрил 130×130'

    document.getElementById('img-14').setAttribute('data-title', '«Поле дикой мяты»')
    document.getElementById('img-14').setAttribute('data-description', 'Акрил 120×120')
    document.getElementById('img-title-14').innerText = '«Поле дикой мяты»'
    document.getElementById('img-subtitle-14').innerText = 'Акрил 120×120'

    document.getElementById('img-15').setAttribute('data-title', '«Там, где падают малиновые лошади»')
    document.getElementById('img-15').setAttribute('data-description', 'Акрил 130×130')
    document.getElementById('img-title-15').innerText = '«Там, где падают малиновые лошади»'
    document.getElementById('img-subtitle-15').innerText = 'Акрил 130×130'
